...
SHORT_RANGE = (0, 1.0)    # 短期patches的范围 (start_ratio, end_ratio)
LONG_RANGE = (0, 1.0)     # 长期patches的范围 (start_ratio, end_ratio)
LONG_STEP = 0.15          # 长期patches的步长比例

class DownstreamPatchExtractor(BasePatchExtractor):
...
if __name__ == "__main__":
    ...
    output_dir = "data/downstream_patches"
    
    extractor = DownstreamPatchExtractor(
        csv_path=csv_path,
